...
scene += Sphere(center=Vector(0, 0, 3), radius=1, color=Vector(0, 0.2, 0), refractive_index=1.5, transparent=True, user_params={'specular':0.25, 'n_s':10, 'absorption_color':Vector(0, 0, 1)})
