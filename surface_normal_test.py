...
scene += Sphere(center=Vector(0, 0, 3), radius=0.6, color=Vector(0, 0, 1))
scene += Sphere(center=Vector(-3, 0, 3), radius=0.6, color=Vector(0, 0, 1))
scene += Sphere(center=Vector(3, 0, 3), radius=0.6, color=Vector(0, 0, 1))
scene += Sphere(center=Vector(0, 3, 3), radius=0.6, color=Vector(0, 0, 1), transparent=True)
